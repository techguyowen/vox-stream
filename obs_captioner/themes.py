...
THEME_PRESETS: Dict[str, ThemePreset] = {
    ...
    "broadcast_bar": ThemePreset(
        id="broadcast_bar",
        name="Flush Broadcast Bar (News / Ticker)",
        description="Edge-to-edge full width lower-third bar with subtle cyan divider, anchored flush to bottom.",
        font_family="'Oswald', 'Inter', sans-serif",
        font_size="32px",
        font_weight="700",
        line_height="1.25",
    ...
    "sanctuary_high_contrast": ThemePreset(
        ...
        name="Sanctuary High-Contrast (LED / Projection)",
        description="Deep opaque backing engineered to prevent stage lighting washout on LED walls and projectors.",
        font_family="'Montserrat', sans-serif",
        font_size="36px",
        font_weight="700",
        line_height="1.4",
    ...
    "floating_clean": ThemePreset(
        id="floating_clean",
        name="Boxless Floating Subtitles (Clean Video)",
        description="100% transparent backing with dual-stroke shadow. Completely unobstructed view of speaker and podium.",
        font_family="'Inter', sans-serif",
        font_size="34px",
        font_weight="700",
        line_height="1.3",
    ...
    "chyron_left": ThemePreset(
        id="chyron_left",
        name="Off-Center Chyron Left (Speaker Clear)",
        description="Docked to lower-left corner with accent marker, leaving center frame clear for speaker and sermon slides.",
        font_family="'Inter', sans-serif",
        font_size="30px",
        font_weight="700",
        line_height="1.35",
    ...
    "teleprompter_stage": ThemePreset(
        ...
        name="Stage Teleprompter (Long-Distance 40ft+)",
        description="Extra-large 44px high-contrast typography engineered for readability across large auditoriums.",
        font_family="'Inter', sans-serif",
        font_size="44px",
        font_weight="800",
        line_height="1.3",
